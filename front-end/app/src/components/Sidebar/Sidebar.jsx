        ...
        <div className="m-4">
          <ul className="mb-4 flex flex-col gap-1">
            <li>
              ...
              <SidebarButton
                to="/Inicio" active={activeButton === 'Inicio'} onClick={() => handleButtonClick('Inicio')}>
            ...
            <li>
              ...
              <SidebarButton
                to="/Reportes" active={activeButton === 'Reportes'} onClick={() => handleButtonClick('Reportes')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-5 h-5 text-inherit">
            ...
            <li>
              <SidebarButton
                to="/Crear-Reporte" active={activeButton === 'Crear-Reporte'} onClick={() => handleButtonClick('Crear-Reporte')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-5 h-5 text-inherit">
                ...
                <p className="block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Crear Nuevo Informe</p>
              </SidebarButton>
            </li>
          </ul>
          <ul className="mb-4 flex flex-col gap-1">
